...
use crate::{
    ...
    Collision, CylinderShape, DataPod, Deque, DpStr, DpString, Euler, ForwardList, GaussianBox,
    ...
    JointMimic, JointSafetyController, JointType, KV, Layer, Line, Linestring, Link, List, Loc,
    MacAddr, Map, MapEntry, Material, Matrix, MeshShape, Model, MultiPoint, Obb, Odom, PagedVecvec,
    Path, Point, PointKey, Polygon, Pose, Quaternion, Queue, Rectangle, Ring, Robot, Segment,
    Sensor, Set, SetEntry, Size, SphereShape, Square, Stack, State, Tensor, Trajectory, Transform,
    Transmission, TransmissionJoint, Triangle, Twist, Utm, Uuid, Vector, Vecvec, Velocity, Visual,
    Wrench,
};
    ...
    R: crate::DataPod<Header = R> + crate::DataPodValidate + bytemuck::Pod + Copy,
{
    clear_last_error();
    if out.is_null() {
        set_last_error("null output value");
        return false;
    }
...
macro_rules! fixed_wire_fns {
    (
        ...
        pub extern "C" fn $type_hash_fn() -> u64 {
            crate::bind::type_hash::<$rust_ty>()
        }

        #[unsafe(no_mangle)]
        pub extern "C" fn $header_size_fn() -> usize {
            crate::bind::header_size::<$rust_ty>()
        }
    ...
    R: bytemuck::Pod,
{
    ...
    if bytes.len() < std::mem::size_of::<R>() {
        set_last_error(format!(
            "input buffer too small: need {}, got {}",
            std::mem::size_of::<R>(),
            bytes.len()
        ));
        return false;
    }
    let value = bytemuck::pod_read_unaligned::<R>(&bytes[..std::mem::size_of::<R>()]);
    unsafe {
        *out = C::from(value);
    }
    true
...
pub extern "C" fn datapod_size_value_type_hash() -> u64 {
    crate::bind::type_hash::<Size>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_size_value_header_size() -> usize {
    crate::bind::header_size::<Size>()
}
...
pub extern "C" fn datapod_box3_type_hash() -> u64 {
    crate::bind::type_hash::<crate::Box>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_box3_header_size() -> usize {
    crate::bind::header_size::<crate::Box>()
}
...
pub extern "C" fn datapod_segment_header_size() -> usize {
    crate::bind::header_size::<Segment>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_euler_type_hash() -> u64 {
    crate::bind::type_hash::<Euler>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_euler_header_size() -> usize {
    crate::bind::header_size::<Euler>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_quaternion_type_hash() -> u64 {
    crate::bind::type_hash::<Quaternion>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_quaternion_header_size() -> usize {
    crate::bind::header_size::<Quaternion>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_pose_type_hash() -> u64 {
    crate::bind::type_hash::<Pose>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_pose_header_size() -> usize {
    crate::bind::header_size::<Pose>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_velocity_type_hash() -> u64 {
    crate::bind::type_hash::<Velocity>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_velocity_header_size() -> usize {
    crate::bind::header_size::<Velocity>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_acceleration_type_hash() -> u64 {
    crate::bind::type_hash::<Acceleration>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_acceleration_header_size() -> usize {
    crate::bind::header_size::<Acceleration>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_transform_type_hash() -> u64 {
    crate::bind::type_hash::<Transform>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_transform_header_size() -> usize {
    crate::bind::header_size::<Transform>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_state_type_hash() -> u64 {
    crate::bind::type_hash::<State>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_state_header_size() -> usize {
    crate::bind::header_size::<State>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_loc_type_hash() -> u64 {
    crate::bind::type_hash::<Loc>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_loc_header_size() -> usize {
    crate::bind::header_size::<Loc>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_utm_type_hash() -> u64 {
    crate::bind::type_hash::<Utm>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_utm_header_size() -> usize {
    crate::bind::header_size::<Utm>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_line_type_hash() -> u64 {
    crate::bind::type_hash::<Line>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_line_header_size() -> usize {
    crate::bind::header_size::<Line>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_rectangle_type_hash() -> u64 {
    crate::bind::type_hash::<Rectangle>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_rectangle_header_size() -> usize {
    crate::bind::header_size::<Rectangle>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_aabb_type_hash() -> u64 {
    crate::bind::type_hash::<Aabb>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_aabb_header_size() -> usize {
    crate::bind::header_size::<Aabb>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_bounding_sphere_type_hash() -> u64 {
    crate::bind::type_hash::<BoundingSphere>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_bounding_sphere_header_size() -> usize {
    crate::bind::header_size::<BoundingSphere>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_circle_type_hash() -> u64 {
    crate::bind::type_hash::<Circle>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_circle_header_size() -> usize {
    crate::bind::header_size::<Circle>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_triangle_type_hash() -> u64 {
    crate::bind::type_hash::<Triangle>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_triangle_header_size() -> usize {
    crate::bind::header_size::<Triangle>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_twist_type_hash() -> u64 {
    crate::bind::type_hash::<Twist>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_twist_header_size() -> usize {
    crate::bind::header_size::<Twist>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_wrench_type_hash() -> u64 {
    crate::bind::type_hash::<Wrench>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_wrench_header_size() -> usize {
    crate::bind::header_size::<Wrench>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_odom_type_hash() -> u64 {
    crate::bind::type_hash::<Odom>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_odom_header_size() -> usize {
    crate::bind::header_size::<Odom>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_joint_limits_type_hash() -> u64 {
    crate::bind::type_hash::<JointLimits>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_joint_limits_header_size() -> usize {
    crate::bind::header_size::<JointLimits>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_inertial_type_hash() -> u64 {
    crate::bind::type_hash::<Inertial>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_inertial_header_size() -> usize {
    crate::bind::header_size::<Inertial>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_uuid_type_hash() -> u64 {
    crate::bind::type_hash::<Uuid>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_uuid_header_size() -> usize {
    crate::bind::header_size::<Uuid>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_ip_type_hash() -> u64 {
    crate::bind::type_hash::<Ip>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_ip_header_size() -> usize {
    crate::bind::header_size::<Ip>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_mac_addr_type_hash() -> u64 {
    crate::bind::type_hash::<MacAddr>()
}
#[unsafe(no_mangle)]
pub extern "C" fn datapod_mac_addr_header_size() -> usize {
    crate::bind::header_size::<MacAddr>()
}
#[unsafe(no_mangle)]
...
pub extern "C" fn datapod_bytes_value_new(ptr: *const u8, len: usize) -> *mut DatapodBytesValue {
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodBytesValue {
        inner: Bytes { data },
    }))
}
...
pub extern "C" fn datapod_dpstr_new(ptr: *const u8, len: usize) -> *mut DatapodDpStr {
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodDpStr {
...
pub extern "C" fn datapod_dpstring_new(ptr: *const u8, len: usize) -> *mut DatapodDpString {
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodDpString {
        inner: DpString::new(bytes),
    }))
}
...
pub extern "C" fn datapod_linestring_new(
    ...
    let points = match unsafe { points_in(points, len) } {
        Ok(points) => points.iter().copied().map(Point::from).collect(),
        Err(()) => return ptr::null_mut(),
    };
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodLinestring {
        inner: Linestring::new(points),
    }))
}
...
pub extern "C" fn datapod_multi_point_new(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodMultiPoint {
        inner: MultiPoint::new(points),
    }))
}
...
pub extern "C" fn datapod_ring_new(points: *const DatapodPoint, len: usize) -> *mut DatapodRing {
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodRing {
        inner: Ring::new(points),
    }))
}
...
unsafe fn poses_in<'a>(ptr: *const DatapodPose, len: usize) -> Result<&'a [DatapodPose], ()> {
    if ptr.is_null() {
        if len == 0 {
            ...
            set_last_error("null pose array with non-zero length");
            Err(())
        }
    } else {
        Ok(unsafe { std::slice::from_raw_parts(ptr, len) })
...
unsafe fn states_in<'a>(ptr: *const DatapodState, len: usize) -> Result<&'a [DatapodState], ()> {
    if ptr.is_null() {
        if len == 0 {
            ...
            set_last_error("null state array with non-zero length");
            Err(())
        }
    } else {
        Ok(unsafe { std::slice::from_raw_parts(ptr, len) })
...
pub extern "C" fn datapod_path_new(waypoints: *const DatapodPose, len: usize) -> *mut DatapodPath {
    ...
    let waypoints = match unsafe { poses_in(waypoints, len) } {
        Ok(poses) => poses.iter().copied().map(Pose::from).collect(),
        Err(()) => return ptr::null_mut(),
    };
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodPath {
        inner: Path::new(waypoints),
    }))
}
...
pub extern "C" fn datapod_trajectory_new(
    ...
    let states = match unsafe { states_in(states, len) } {
        Ok(states) => states.iter().copied().map(State::from).collect(),
        Err(()) => return ptr::null_mut(),
    };
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodTrajectory {
        inner: Trajectory::new(states),
    }))
}
...
pub extern "C" fn datapod_grid_new(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodGrid {
        inner: Grid::new(
            rows,
            cols,
            encoding,
...
pub extern "C" fn datapod_layer_new(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodLayer {
        inner: Layer {
            rows,
            cols,
            layers,
...
pub extern "C" fn datapod_map_new() -> *mut DatapodMap {
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodMap { inner: Map::new() }))
}
...
pub extern "C" fn datapod_map_insert(
    ...
    unsafe { &mut *map }.inner.insert(key, value);
    true
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_set_new() -> *mut DatapodSet {
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodSet { inner: Set::new() }))
}
...
pub extern "C" fn datapod_set_insert(set: *mut DatapodSet, key: *const u8, key_len: usize) -> bool {
    ...
    unsafe { &mut *set }.inner.insert(key)
}
...
pub extern "C" fn datapod_vector_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodVector {
        inner: Vector {
            element_size,
            _pad: 0,
            data,
...
pub extern "C" fn datapod_matrix_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodMatrix {
        inner: Matrix {
            rows,
            cols,
            element_size,
...
pub extern "C" fn datapod_tensor_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodTensor {
        inner: Tensor {
            rows,
            cols,
            layers,
...
pub extern "C" fn datapod_bitvec_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodBitVec {
...
pub extern "C" fn datapod_deque_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodDeque {
        inner: Deque {
            element_size,
            split_byte,
            data,
...
pub extern "C" fn datapod_queue_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodQueue {
        inner: Queue {
            element_size,
            front,
            data,
...
pub extern "C" fn datapod_stack_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodStack {
        inner: Stack {
            element_size,
            _pad: 0,
            data,
...
pub extern "C" fn datapod_list_empty(element_size: u32) -> *mut DatapodList {
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodList {
        inner: List {
...
pub extern "C" fn datapod_forward_list_empty(element_size: u32) -> *mut DatapodForwardList {
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodForwardList {
        inner: ForwardList {
...
pub extern "C" fn datapod_heap_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodHeap {
        inner: Heap {
            element_size,
            order: if min_order {
...
pub extern "C" fn datapod_indexed_heap_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodIndexedHeap {
        inner: IndexedHeap {
            priority_size,
            order: if min_order {
                crate::seq::HeapOrder::Min
...
pub extern "C" fn datapod_vecvec_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodVecvec {
        inner: Vecvec {
            element_size,
            _pad: 0,
            data,
...
pub extern "C" fn datapod_paged_vecvec_from_bytes(
    ...
    std::boxed::Box::into_raw(std::boxed::Box::new(DatapodPagedVecvec {
        inner: PagedVecvec {
            element_size,
            _pad: 0,
            data,
...
pub extern "C" fn datapod_bytes_value_type_hash() -> u64 {
    crate::bind::type_hash::<Bytes>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_bytes_value_header_size() -> usize {
    crate::bind::header_size::<Bytes>()
}
...
pub extern "C" fn datapod_dpstring_type_hash() -> u64 {
    crate::bind::type_hash::<DpString>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_dpstring_header_size() -> usize {
    crate::bind::header_size::<DpString>()
}
...
pub extern "C" fn datapod_linestring_type_hash() -> u64 {
    crate::bind::type_hash::<Linestring>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_linestring_header_size() -> usize {
    crate::bind::header_size::<Linestring>()
}
...
pub extern "C" fn datapod_multi_point_type_hash() -> u64 {
    crate::bind::type_hash::<MultiPoint>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_multi_point_header_size() -> usize {
    crate::bind::header_size::<MultiPoint>()
}
...
pub extern "C" fn datapod_ring_type_hash() -> u64 {
    crate::bind::type_hash::<Ring>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_ring_header_size() -> usize {
    crate::bind::header_size::<Ring>()
}
...
pub extern "C" fn datapod_trajectory_header_size() -> usize {
    crate::bind::header_size::<Trajectory>()
}
...
pub extern "C" fn datapod_vector_type_hash() -> u64 {
    crate::bind::type_hash::<Vector>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_vector_header_size() -> usize {
    crate::bind::header_size::<Vector>()
}
...
pub extern "C" fn datapod_stack_type_hash() -> u64 {
    crate::bind::type_hash::<Stack>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_stack_header_size() -> usize {
    crate::bind::header_size::<Stack>()
}
...
pub extern "C" fn datapod_forward_list_header_size() -> usize {
    crate::bind::header_size::<ForwardList>()
}
...
pub extern "C" fn datapod_indexed_heap_header_size() -> usize {
    crate::bind::header_size::<IndexedHeap>()
}
...
pub extern "C" fn datapod_vecvec_type_hash() -> u64 {
    crate::bind::type_hash::<Vecvec>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_vecvec_header_size() -> usize {
    crate::bind::header_size::<Vecvec>()
}
...
pub extern "C" fn datapod_paged_vecvec_header_size() -> usize {
    crate::bind::header_size::<PagedVecvec>()
}
...
pub extern "C" fn datapod_point_key_type_hash() -> u64 {
    crate::bind::type_hash::<PointKey>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_point_key_header_size() -> usize {
    crate::bind::header_size::<PointKey>()
}
...
pub extern "C" fn datapod_square_type_hash() -> u64 {
    crate::bind::type_hash::<Square>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_square_header_size() -> usize {
    crate::bind::header_size::<Square>()
}
...
pub extern "C" fn datapod_obb_type_hash() -> u64 {
    crate::bind::type_hash::<Obb>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_obb_header_size() -> usize {
    crate::bind::header_size::<Obb>()
}
...
pub extern "C" fn datapod_gaussian_point_type_hash() -> u64 {
    crate::bind::type_hash::<GaussianPoint>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_gaussian_point_header_size() -> usize {
    crate::bind::header_size::<GaussianPoint>()
}
...
pub extern "C" fn datapod_gaussian_circle_type_hash() -> u64 {
    crate::bind::type_hash::<GaussianCircle>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_gaussian_circle_header_size() -> usize {
    crate::bind::header_size::<GaussianCircle>()
}
...
pub extern "C" fn datapod_gaussian_rectangle_type_hash() -> u64 {
    crate::bind::type_hash::<GaussianRectangle>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_gaussian_rectangle_header_size() -> usize {
    crate::bind::header_size::<GaussianRectangle>()
}
...
pub extern "C" fn datapod_gaussian_box_type_hash() -> u64 {
    crate::bind::type_hash::<GaussianBox>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_gaussian_box_header_size() -> usize {
    crate::bind::header_size::<GaussianBox>()
}
...
pub extern "C" fn datapod_accel_type_hash() -> u64 {
    crate::bind::type_hash::<Accel>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_accel_header_size() -> usize {
    crate::bind::header_size::<Accel>()
}
...
pub extern "C" fn datapod_joint_dynamics_type_hash() -> u64 {
    crate::bind::type_hash::<JointDynamics>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_joint_dynamics_header_size() -> usize {
    crate::bind::header_size::<JointDynamics>()
}
...
pub extern "C" fn datapod_joint_mimic_type_hash() -> u64 {
    crate::bind::type_hash::<JointMimic>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_joint_mimic_header_size() -> usize {
    crate::bind::header_size::<JointMimic>()
}
...
pub extern "C" fn datapod_joint_safety_controller_type_hash() -> u64 {
    crate::bind::type_hash::<JointSafetyController>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_joint_safety_controller_header_size() -> usize {
    crate::bind::header_size::<JointSafetyController>()
}
...
pub extern "C" fn datapod_joint_calibration_type_hash() -> u64 {
    crate::bind::type_hash::<JointCalibration>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_joint_calibration_header_size() -> usize {
    crate::bind::header_size::<JointCalibration>()
}
...
pub extern "C" fn datapod_kv_type_hash() -> u64 {
    crate::bind::type_hash::<KV>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_kv_header_size() -> usize {
    crate::bind::header_size::<KV>()
}
...
pub extern "C" fn datapod_box_shape_type_hash() -> u64 {
    crate::bind::type_hash::<BoxShape>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_box_shape_header_size() -> usize {
    crate::bind::header_size::<BoxShape>()
}
...
pub extern "C" fn datapod_sphere_shape_type_hash() -> u64 {
    crate::bind::type_hash::<SphereShape>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_sphere_shape_header_size() -> usize {
    crate::bind::header_size::<SphereShape>()
}
...
pub extern "C" fn datapod_cylinder_shape_type_hash() -> u64 {
    crate::bind::type_hash::<CylinderShape>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_cylinder_shape_header_size() -> usize {
    crate::bind::header_size::<CylinderShape>()
}
...
pub extern "C" fn datapod_mesh_shape_type_hash() -> u64 {
    crate::bind::type_hash::<MeshShape>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_mesh_shape_header_size() -> usize {
    crate::bind::header_size::<MeshShape>()
}
...
pub extern "C" fn datapod_geometry_kind_type_hash() -> u64 {
    crate::bind::type_hash::<GeometryKind>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_geometry_kind_header_size() -> usize {
    crate::bind::header_size::<GeometryKind>()
}
...
pub extern "C" fn datapod_geometry_type_hash() -> u64 {
    crate::bind::type_hash::<Geometry>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_geometry_header_size() -> usize {
    crate::bind::header_size::<Geometry>()
}
...
pub extern "C" fn datapod_identity_type_hash() -> u64 {
    crate::bind::type_hash::<Identity>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_identity_header_size() -> usize {
    crate::bind::header_size::<Identity>()
}
...
pub extern "C" fn datapod_model_type_hash() -> u64 {
    crate::bind::type_hash::<Model>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_model_header_size() -> usize {
    crate::bind::header_size::<Model>()
}
...
pub extern "C" fn datapod_material_type_hash() -> u64 {
    crate::bind::type_hash::<Material>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_material_header_size() -> usize {
    crate::bind::header_size::<Material>()
}
...
pub extern "C" fn datapod_visual_type_hash() -> u64 {
    crate::bind::type_hash::<Visual>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_visual_header_size() -> usize {
    crate::bind::header_size::<Visual>()
}
...
pub extern "C" fn datapod_collision_type_hash() -> u64 {
    crate::bind::type_hash::<Collision>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_collision_header_size() -> usize {
    crate::bind::header_size::<Collision>()
}
...
pub extern "C" fn datapod_joint_type_type_hash() -> u64 {
    crate::bind::type_hash::<JointType>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_joint_type_header_size() -> usize {
    crate::bind::header_size::<JointType>()
}
...
pub extern "C" fn datapod_joint_type_hash() -> u64 {
    crate::bind::type_hash::<Joint>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_joint_header_size() -> usize {
    crate::bind::header_size::<Joint>()
}
...
pub extern "C" fn datapod_link_type_hash() -> u64 {
    crate::bind::type_hash::<Link>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_link_header_size() -> usize {
    crate::bind::header_size::<Link>()
}
...
pub extern "C" fn datapod_sensor_type_hash() -> u64 {
    crate::bind::type_hash::<Sensor>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_sensor_header_size() -> usize {
    crate::bind::header_size::<Sensor>()
}
...
pub extern "C" fn datapod_robot_type_hash() -> u64 {
    crate::bind::type_hash::<Robot>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_robot_header_size() -> usize {
    crate::bind::header_size::<Robot>()
}
...
pub extern "C" fn datapod_actuator_type_hash() -> u64 {
    crate::bind::type_hash::<Actuator>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_actuator_header_size() -> usize {
    crate::bind::header_size::<Actuator>()
}
...
pub extern "C" fn datapod_transmission_joint_type_hash() -> u64 {
    crate::bind::type_hash::<TransmissionJoint>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_transmission_joint_header_size() -> usize {
    crate::bind::header_size::<TransmissionJoint>()
}
...
pub extern "C" fn datapod_transmission_type_hash() -> u64 {
    crate::bind::type_hash::<Transmission>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_transmission_header_size() -> usize {
    crate::bind::header_size::<Transmission>()
}
...
pub extern "C" fn datapod_encoding_type_hash() -> u64 {
    crate::bind::type_hash::<Encoding>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_encoding_header_size() -> usize {
    crate::bind::header_size::<Encoding>()
}
...
pub extern "C" fn datapod_envelope_type_hash() -> u64 {
    crate::bind::type_hash::<Envelope>()
}

#[unsafe(no_mangle)]
pub extern "C" fn datapod_envelope_header_size() -> usize {
    crate::bind::header_size::<Envelope>()
}
