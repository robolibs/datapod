...
namespace std {
    ...
    struct tuple_size<bitcon::Tuple<Pack...>> : bitcon::tuple_size<bitcon::Tuple<Pack...>> {};

    template <std::size_t I, typename... Pack>
    struct tuple_element<I, bitcon::Tuple<Pack...>> : bitcon::tuple_element<I, bitcon::Tuple<Pack...>> {};
