...
#error unsupported compiler
    ...
    template <typename T> constexpr std::string_view type_str() {
        ...
        constexpr std::string_view prefix = "std::string_view bitcon::type_str() [T = ";
        constexpr std::string_view suffix = "]";
#elif defined(_MSC_VER)
        constexpr std::string_view prefix = "class std::basic_string_view<char,struct std::char_traits<char> > "
                                            "__cdecl bitcon::type_str<";
        constexpr std::string_view suffix = ">(void)";
#else
        constexpr std::string_view prefix = "constexpr std::string_view bitcon::type_str() [with T = ";
