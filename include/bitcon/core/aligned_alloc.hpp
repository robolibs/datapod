...
#define DATAGRAM_ALIGNED_ALLOC(alignment, size) (bitcon::aligned_alloc((alignment), (size)))

#define DATAGRAM_ALIGNED_FREE(alignment, ptr) (bitcon::aligned_free((alignment), (ptr)))
