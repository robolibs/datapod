...
#define DATAGRAM_ALIGNED_ALLOC(alignment, size) (datagram::aligned_alloc((alignment), (size)))

#define DATAGRAM_ALIGNED_FREE(alignment, ptr) (datagram::aligned_free((alignment), (ptr)))
