...
namespace std {
    ...
    struct tuple_size<datagram::Tuple<Pack...>> : datagram::tuple_size<datagram::Tuple<Pack...>> {};

    template <std::size_t I, typename... Pack>
    struct tuple_element<I, datagram::Tuple<Pack...>> : datagram::tuple_element<I, datagram::Tuple<Pack...>> {};
