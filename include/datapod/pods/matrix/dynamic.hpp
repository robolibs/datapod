...
#include "datapod/pods/matrix/matrix.hpp"     // For Dynamic, matrix<T, Dynamic, Dynamic>
#include "datapod/pods/matrix/tensor.hpp"     // For tensor<T, Dynamic, ...>
#include "datapod/pods/matrix/vector.hpp"     // For Dynamic, vector<T, Dynamic>
#include "datapod/pods/sequential/vector.hpp" // For datapod::Vector (shape storage)
