...
namespace datapod {
    ...
    namespace geometry {
        ...
        inline Geometry cylinder(f64 radius, f64 length) noexcept { return Geometry{CylinderShape{radius, length}}; }
        inline Geometry mesh(const String &uri, const Array<f64, 3> &scale = Array<f64, 3>{1.0, 1.0, 1.0}) noexcept {
